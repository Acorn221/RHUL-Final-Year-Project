...
Video Link: https://youtu.be/w8QszC0jRiY
...
In practice, there's usually more than one singular method of hyperparameter tuning that is used to find the best set of hyperparameters. I essentially combined random search with a genetic algorithm, as I randomly chose the hyperparameters, and then I chose the best set of hyperparameters based on the validation accuracy, and repeated that in the juypter notebook until I felt that I had found the best set of hyperparameters.

\subsection{The Metrics}

There are a few metrics that can be used to evaluage the performance of a model in a real world scenario.
...
Finally, the F1 score is a measure of a model's accuracy on a dataset. It is used to evaluate binary classification systems, which classify examples into 'positive' or 'negative'. The F1 score is a way of combining the precision and recall of the model, and it is defined as the harmonic mean of the model's precision and recall. This is how I'm evaluating the models, as it gives a good general idea of generally how good the model is.
