...
From FFT pruning in 1965\cite{FFT} to iterative magnitude pruning in 2019\cite{LotteryTicket},
...
I am intending on using \href{https://github.com/JJGO/shrinkbench}{ShrinkBench} to compare the pruning algorithms,
...
The pre-trained models that I currently intend to use are:
\begin{itemize}
	\item VGG16
	\item VGG19
	\item ResNet50V2
